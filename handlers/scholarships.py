...
def format_scholarship_details(scholarship):
    ...
    if scholarship.get("foreign_students"):
        ...
        text += "🌍 <b>Для иностранных студентов:</b>\n"
...
def get_categories_keyboard():
    ...
    for i, category in enumerate(categories):
        btn = InlineKeyboardButton(text=category["name"], callback_data=f"sch_cat_{i}")
...
def get_scholarships_keyboard(cat_index):
            ...
            inline_keyboard=[
                [
                    InlineKeyboardButton(
                        text="🔙 К категориям", callback_data="sch_back_to_categories"
                    )
                ],
                [
                    InlineKeyboardButton(
                        text="🔙 В раздел студента", callback_data="sch_back_to_menu"
                    )
                ],
            ]
        )
    ...
    for sch_idx, scholarship in enumerate(scholarships):
        btn = InlineKeyboardButton(
            text=scholarship["name"], callback_data=f"sch_scholarship_{cat_index}_{sch_idx}"
        )
        keyboard.inline_keyboard.append([btn])
...
def get_scholarship_detail_keyboard(cat_index):
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🔙 К списку стипендий",
                    callback_data=f"sch_back_to_scholarships_{cat_index}",
                )
            ],
            [InlineKeyboardButton(text="🔙 К категориям", callback_data="sch_back_to_categories")],
            [InlineKeyboardButton(text="🔙 В раздел студента", callback_data="sch_back_to_menu")],
